...
//     //         const response = await axios.delete(`/project/${projectId}/task/${taskId}`);
            
//     //         if (response.status === 200) {
//     //             // Task deleted successfully, refresh data
//     //             refreshData();
//     //         } else {
...
// //     // Make an API call to delete the task using the projectId and taskId (index)
// //     axios.delete(`/api/project/${projectId}/task/${taskId}`)
// //         .then(response => {
// //             console.log('Task deleted successfully');
// //             // Update the UI (e.g., refresh the task list or remove the deleted task)
// //         })
// //         .catch(error => {
// //             console.error('Error deleting task:', error);
// //         });
