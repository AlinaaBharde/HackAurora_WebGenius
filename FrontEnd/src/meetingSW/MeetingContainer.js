...
import { SidebarConatiner } from "../componentsSW/sidebar/SidebarContainer";
import MemorizedParticipantView from "./components/ParticipantView";
import { PresenterView } from "../componentsSW/PresenterView";
import { nameTructed, trimSnackBarText } from "../utilsSW/helper";
import WaitingToJoinScreen from "../componentsSW/screens/WaitingToJoinScreen";
import ConfirmBox from "../componentsSW/ConfirmBox";
...
export function MeetingContainer({
  ...
  return (
    <div className="fixed inset-0 max-h-screen z-10" style={{height:500}}>
